...
@implementation TZStage5Creator

- (NSArray *)groupOfAnimationsToLayer:(CALayer *)layer
{
    NSMutableArray *animationArray = [[NSMutableArray alloc]init];
    
    NSString *script = @"For me, knowing that people enjoy things I've created is the best thing to be a developer.";
    ...
    __block CGFloat currentY = CGRectGetMidY([UIScreen mainScreen].bounds) - 120;
    ...
    lastOperation.animation.duration = 1.2f;
