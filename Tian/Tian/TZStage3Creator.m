...
@implementation TZStage3Creator

- (NSArray *)groupOfAnimationsToLayer:(CALayer *)layer
{
    NSMutableArray *animationArray = [[NSMutableArray alloc]init];
    
    NSString *script = @"The world changed a lot over past six years.";
    ...
    __block CGFloat currentY = CGRectGetMidY([UIScreen mainScreen].bounds) - 50;
    ...
    lastOperation.animation.duration = 0.66f;
